...
const LandingPage = () => {
    ...
    const scrollOurClasses = useRef(null);

    const handleScroll = () => {
        scrollAboutUs.current.scrollIntoView({ behavior: 'smooth'});
        scrollOurClasses.current.scrollIntoView({behavior: 'smooth'});
    };
        ...
        <>
            <header className='contHeader'>
                    <div className='contHeaderTxt'>
                        ...
                        <button className='btnHeader'>Get started</button>
                    </div>
            </header>
            <main>
                <section className='contCards'>
                    <div ref={scrollAboutUs} id="scrollAboutUs" className='cardInfo'>
                ...
                <section ref={scrollOurClasses} id="scrollOurClasses" className='contTtClasses'>
                    <div>
                ...
                <section className='contPlansPricing'>
                    ...
                    <section className='contPricing'>
                        <div className='prcingInfo'>
                            ...
                            <button className='btnPricing'>Get started</button>
                        </div>
